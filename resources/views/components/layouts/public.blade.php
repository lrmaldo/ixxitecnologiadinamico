            ...
            <div class="mx-auto max-w-7xl px-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="space-y-4">
                        ...
                        <div class="pt-2 flex space-x-4">
                            ...
                            <a href="{{ $socialLinks['facebook'] }}" class="text-zinc-500 hover:text-[#021869] transition-colors duration-300" aria-label="Facebook" target="_blank">
                            ...
                            <a href="{{ $socialLinks['instagram'] }}" class="text-zinc-500 hover:text-[#021869] transition-colors duration-300" aria-label="Instagram" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ $socialLinks['twitter'] }}" class="text-zinc-500 hover:text-[#021869] transition-colors duration-300" aria-label="Twitter" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ $socialLinks['linkedin'] }}" class="text-zinc-500 hover:text-[#021869] transition-colors duration-300" aria-label="LinkedIn" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-12 pt-6 border-t border-zinc-200 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        @if(!empty($socialLinks['facebook']))
                        <a href="{{ $socialLinks['facebook'] }}" target="_blank" class="text-zinc-600 hover:text-[#021869] transition-colors duration-300">
                        ...
                        @if(!empty($socialLinks['instagram']))
                        <a href="{{ $socialLinks['instagram'] }}" target="_blank" class="text-zinc-600 hover:text-[#021869] transition-colors duration-300">
                        ...
                        @if(!empty($socialLinks['twitter']))
                        <a href="{{ $socialLinks['twitter'] }}" target="_blank" class="text-zinc-600 hover:text-[#021869] transition-colors duration-300">
                        ...
                        @if(!empty($socialLinks['linkedin']))
                        <a href="{{ $socialLinks['linkedin'] }}" target="_blank" class="text-zinc-600 hover:text-[#021869] transition-colors duration-300">
