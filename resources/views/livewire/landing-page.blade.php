                    ...
                    @foreach($alliances as $index => $alliance)
                        <div class="group cursor-pointer" data-aos="zoom-in" data-aos-delay="{{ 100 * ($index + 1) }}">
                            <div @click="openModal({
                                ...
                                <!-- Indicador de acción con tooltip -->
                                <div class="absolute bottom-2 right-2 bg-white rounded-full p-1 shadow-md opacity-0 group-hover:opacity-100 transition-opacity">
                                    <svg class="w-4 h-4 text-[#204369]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
